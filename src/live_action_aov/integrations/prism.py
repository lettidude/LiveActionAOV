...
"""Prism pipeline adapter — stub for v2."""
...
class PrismAdapterStub(PipelineAdapter):
    name = "prism"

    def attach_ids(self, shot: Shot) -> Shot:  # pragma: no cover — stub
        raise NotImplementedError("Prism integration lands in v2.")

    def publish(self, shot: Shot) -> None:  # pragma: no cover — stub
        raise NotImplementedError("Prism integration lands in v2.")


__all__ = ["PrismAdapterStub"]
