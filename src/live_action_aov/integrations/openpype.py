...
"""OpenPype pipeline adapter — stub for v2."""
...
class OpenPypeAdapterStub(PipelineAdapter):
    name = "openpype"

    def attach_ids(self, shot: Shot) -> Shot:  # pragma: no cover — stub
        raise NotImplementedError("OpenPype integration lands in v2.")

    def publish(self, shot: Shot) -> None:  # pragma: no cover — stub
        raise NotImplementedError("OpenPype integration lands in v2.")


__all__ = ["OpenPypeAdapterStub"]
